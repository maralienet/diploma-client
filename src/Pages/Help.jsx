        ...
        <div className='help'>
            ...
            <div>
                <main>
                    ...
                    что возможно сделать, нажав на кнопку «Войти» в
                    хедере. Далее вам надо введи свой логин и пароль от аккаунта
                    и нажать на кнопку «Войти»на форме.`}
                        highlights={['«Войти»']} id='adv8'
                    />
                    ...
                    страницу личного кабинета, нажмите в меню на нужный вам 
                    ...
                    вам необходимо перейти в личный кабинет, нажав на 
                    соответствующую кнопку в хедере. После перехода на 
                    страницу личного кабинета, нажмите в меню на нужную вам 
